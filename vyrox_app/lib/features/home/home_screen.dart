  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text('VYROX AI', style: TextStyle(fontSize: 34, fontWeight: FontWeight.bold, color: Colors.white, letterSpacing: -4)),
              const Text('STUDIO', style: TextStyle(fontSize: 34, fontWeight: FontWeight.bold, color: Color(0xFFC8F560), letterSpacing: -4)),
              ...
              GridView.builder(
                ...
                itemBuilder: (_, i) {
                  ...
                  return GestureDetector(
                    onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const CreateScreen())),
                    child: Container(
                      ...
                      child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                        Stack(alignment: Alignment.topRight, children: [
                          ...
                          Positioned(top: 0, right: 0, child: Container(
                            ...
                            child: Text(t['badge'] as String, style: const TextStyle(fontSize: 9, fontWeight: FontWeight.bold, color: Colors.white)),
                          )),
                        ]),
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        currentIndex: 0,
        onTap: (i) {
          if (i == 1) Navigator.push(context, MaterialPageRoute(builder: (_) => const CreateScreen()));
