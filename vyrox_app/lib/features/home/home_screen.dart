  ...
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            children: [
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Row(children: [
                    Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: const [Text('Discover', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Colors.white)), SizedBox(height: 4), Text('Community prompts & trending tools', style: TextStyle(fontSize: 13, color: Colors.white70))])),
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        currentIndex: 0,
        onTap: (i) {
          if (i == 1) Navigator.push(context, MaterialPageRoute(builder: (_) => const CreateToolScreen()));
