            ...
            Container(
              ...
              child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [
                  const Text('lik1988', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Colors.white, letterSpacing: -1)),
                  const SizedBox(height: 2),
                  const Text('@gmail.com', style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Colors.white70)),
                  const SizedBox(height: 8),
                  Row(children: [
                    const Text('Signed in', style: TextStyle(color: Colors.white60, fontSize: 13)),
                    const Spacer(),
            ...
            Container(
              ...
              child: Row(children: [
                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: const [
                  Text('Plan · Free', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.black87)),
                  SizedBox(height: 4),
                  Text('Unlock Turbo and Avatar priority', style: TextStyle(fontSize: 13, color: Colors.black87)),
                ])),
                ElevatedButton(onPressed: () {}, style: ElevatedButton.styleFrom(backgroundColor: Colors.black, foregroundColor: Colors.white, shape: const StadiumBorder(), padding: const EdgeInsets.symmetric(horizontal: 18, vertical: 12), elevation: 0), child: const Text('Upgrade', style: TextStyle(fontWeight: FontWeight.bold))),
              ]),
            ),
            const SizedBox(height: 16),
            Container(
